...
// Force revalidation for fresh data - Updated 2026-09-11
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          <h2 className="text-xl font-semibold text-red-900 mb-2">Error Loading Page</h2>
          <p className="text-red-700 mb-4">An unexpected error occurred while loading the About page.</p>
          <Link 
            href="/" 
